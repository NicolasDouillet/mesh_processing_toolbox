...
%
%       [|  |  | ]
% - T = [i1 i2 i3], positive integer matrix double, the triangulation, size(T) = [nb_input_triangles,3]. Mandatory.
%       [|  |  | ]
%
...
%          just identified with their indices (positive integer scalar
%          double). Case insensitive. Optional.
%
%
%%% Output arguments
%
