...
To do this, just execute addpath(genpath('my_path_to_the_sources')); command in Matlab console, where 'my_path_to_the_sources' is the path to mesh_processing_toolbox/src on your computer.
